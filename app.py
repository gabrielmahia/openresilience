...
st.set_page_config(
    page_title="WapiMaji — Water & Drought Intelligence Kenya",
    layout="wide",
    page_icon="💧",
...
with col_h1:
    st.title("💧 WapiMaji — Water & Drought Intelligence")
...
with st.sidebar:
    ...
    st.markdown(
        ...
        "[:bug: Report a bug](https://github.com/gabrielmahia/openresilience/issues/new)\n\n"
        "---\n"
